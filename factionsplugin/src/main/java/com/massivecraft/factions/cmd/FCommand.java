...
public abstract class FCommand extends MCommand<P> {
    ...
    public boolean validSenderType(CommandSender sender, boolean informSenderIfNot) {
        ...
        if (this.senderMustBeModerator && !fme.getRole().isAtLeast(Role.MODERATOR) && !fme.isAdminBypassing()) {
        ...
        if (this.senderMustBeAdmin && !fme.getRole().isAtLeast(Role.COLEADER) && !fme.isAdminBypassing()) {
    ...
    public boolean canIAdministerYou(FPlayer i, FPlayer you) {
        ...
        if (you.getRole().equals(Role.ADMIN)) {
            ...
            if (i == you) {
                return true; //Coleaders can control themselves
            } else if (you.getRole().equals(Role.MODERATOR) || you.getRole().equals(Role.NORMAL)
                    || you.getRole().equals(Role.RECRUIT)) {
                return true; //Coleaders can control groups below them
            } else {
