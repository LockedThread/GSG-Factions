        ...
        this.doWarmUp(WarmUpUtil.Warmup.HOME, TL.WARMUPS_NOTIFY_TELEPORT, "Home", new Runnable() {
            ...
            public void run() {
                ...
                if (Conf.homesTeleportCommandSmokeEffectEnabled) {
                    ...
                    smokeLocations.add(com.massivecraft.factions.cmd.CmdHome.this.myFaction.getHome());
                    smokeLocations.add(com.massivecraft.factions.cmd.CmdHome.this.myFaction.getHome().clone().add(0, 1, 0));
                    SmokeUtil.spawnCloudRandom(smokeLocations, Conf.homesTeleportCommandSmokeEffectThickness);
                }

                com.massivecraft.factions.cmd.CmdHome.this.me.teleport(com.massivecraft.factions.cmd.CmdHome.this.myFaction.getHome());
            }
