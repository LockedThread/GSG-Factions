...
public class CmdCreate extends FCommand {
    ...
    private static final Cache<UUID, Boolean> CREATE_COOLDOWN = CacheBuilder.newBuilder().expireAfterWrite(30, TimeUnit.SECONDS).build();
    ...
    public void perform() {
        ...
        if (CREATE_COOLDOWN.getIfPresent(me.getUniqueId()) != null) {
            msg("<b>You must wait 30 seconds between creating new Factions!");
            return;
        }
        CREATE_COOLDOWN.put(me.getUniqueId(), true);
