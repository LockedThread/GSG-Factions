...
public abstract class Factions {
    ...
    protected static com.massivecraft.factions.Factions instance = getFactionsImpl();

    public static com.massivecraft.factions.Factions getInstance() {
        return instance;
    }

    private static com.massivecraft.factions.Factions getFactionsImpl() {
        switch (Conf.backEnd) {
            case JSON:
