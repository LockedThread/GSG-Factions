...
public class FactionsChatListener implements Listener {
    ...
    public void onPlayerChat(AsyncPlayerChatEvent event) {
        ...
        String formatStart = eventFormat.substring(0, InsertIndex) + ((Conf.chatTagPadBefore && !me.getChatTag().isEmpty()) ? "§8[" : "");
        String formatEnd = ((Conf.chatTagPadAfter && !me.getChatTag().isEmpty()) ? "§8] " : "") + eventFormat.substring(InsertIndex);
        ...
        if (Conf.chatTagRelationColored) {
            ...
            for (Player listeningPlayer : event.getRecipients()) {
                ...
                if (you.isMutedChatEnabled()) continue;
