...
public class ConcurrentHashSet<E> extends AbstractSet<E> implements Set<E>, Cloneable, Serializable {
    ...
    /**
     * This is what you call a "I hate you Oracle!", Oracle loves making all of their subclasses final and their visibility private so people can't do shit.
     */
    private final class KeyIterator implements Iterator<E> {
        ...
        public KeyIterator() {
            this.iterator = ConcurrentHashSet.this.concurrentHashMap.keySet().iterator();
        }
