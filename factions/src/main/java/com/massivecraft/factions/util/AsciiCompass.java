...
public class AsciiCompass {
    ...
    public static com.massivecraft.factions.util.AsciiCompass.Point getCompassPointForDirection(double inDegrees) {
        ...
        if (0 <= degrees && degrees < 22.5) {
            return com.massivecraft.factions.util.AsciiCompass.Point.N;
        } else if (22.5 <= degrees && degrees < 67.5) {
            return com.massivecraft.factions.util.AsciiCompass.Point.NE;
        } else if (67.5 <= degrees && degrees < 112.5) {
            return com.massivecraft.factions.util.AsciiCompass.Point.E;
        } else if (112.5 <= degrees && degrees < 157.5) {
            return com.massivecraft.factions.util.AsciiCompass.Point.SE;
        } else if (157.5 <= degrees && degrees < 202.5) {
            return com.massivecraft.factions.util.AsciiCompass.Point.S;
        } else if (202.5 <= degrees && degrees < 247.5) {
            return com.massivecraft.factions.util.AsciiCompass.Point.SW;
        } else if (247.5 <= degrees && degrees < 292.5) {
            return com.massivecraft.factions.util.AsciiCompass.Point.W;
        } else if (292.5 <= degrees && degrees < 337.5) {
            return com.massivecraft.factions.util.AsciiCompass.Point.NW;
