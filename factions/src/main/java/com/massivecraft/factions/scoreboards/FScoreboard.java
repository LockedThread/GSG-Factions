...
public class FScoreboard {
    ...
    private static final Map<FPlayer, com.massivecraft.factions.scoreboards.FScoreboard> fscoreboards = new HashMap<>();

    private final Scoreboard scoreboard;
    private final FPlayer fplayer;
    private final com.massivecraft.factions.scoreboards.BufferedObjective bufferedObjective;
    ...
    public static void init(FPlayer fplayer) {
        com.massivecraft.factions.scoreboards.FScoreboard fboard = new com.massivecraft.factions.scoreboards.FScoreboard(fplayer);
    ...
    public static void remove(FPlayer fplayer) {
        com.massivecraft.factions.scoreboards.FScoreboard fboard = fscoreboards.remove(fplayer);
    ...
    public static com.massivecraft.factions.scoreboards.FScoreboard get(FPlayer fplayer) {
        return fscoreboards.get(fplayer);
    }

    public static com.massivecraft.factions.scoreboards.FScoreboard get(Player player) {
