...
public enum TL {
    ...
    COMMAND_CORNER_ATTEMPTING("&7&oAttempting to claim 20x20 chunks..."),
    COMMAND_CORNER_SUCCESS("\n&aYou have successfully claimed &f%1$d &achunks!\n"),
    COMMAND_CORNER_DESCRIPTION("Allows you to claim a corner automatically"),

    COMMAND_PAYPAL_DESCRIPTION("Allows faction leaders to see their PayPal"),
    COMMAND_PAYPAL_NO_PAYPAL_SET("&cYou don't have a PayPal set. Execute /f setpaypal [email] to set it."),
    ...
    COMMAND_ALTS_LONG("&eThe faction alts commands."),
    COMMAND_ALTS_DESCRIPTION("Faction alts commands"),

    COMMAND_ALTS_LIST("view all alts"),
    COMMAND_ALTS_INVLIST("view all pending alt invites"),
    COMMAND_ALTS_INVITE("send an alt invite"),
    ...
    COMMAND_BAN_TARGETALREADYBANNED("&c%1$s is already banned"),
    ...
    COMMAND_SPAWNCHUNK("Mark chunks to allow spawner placing"),
    ...
    COMMAND_FWARPOTHER_DESCRIPTION("Teleport to another faction's warp"),
    ...
    COMMAND_OWNER_ALL_ADDED("&eYou have added %1$s&e to the owner list for &lALL &eof your claimed land."),
    COMMAND_OWNER_ALL_CLEARED("&eYou have removed %1$s&e from the owner list for &lALL &eof your claimed land."),
    COMMAND_OWNER_DESCRIPTION("Set ownership of claimed land"),
    COMMAND_OWNER_ALL_DESCRIPTION("Set ownership of ALL claimed land at once"),
    ...
    COMMAND_PROMOTE_NOT_ALLOWED("You can't promote that player."),
    COMMAND_DEMOTE_NOT_ALLOWED("You can't demote that player."),
    ...
    COMMAND_STATUS_DESCRIPTION("Show the status of your Faction"),
    ...
    COMMAND_TNT_DESCRIPTION("Manage your Faction's TNT bank"),

    COMMAND_TNTFILL_DESCRIPTION("Fill nearby dispensers with TNT from your Faction's TNT bank"),
    ...
    COMMAND_STRIKE_DESCRIPTION("View details about Faction Strikes"),
    ...
    GENERIC_NOUSEPERMISSION("&cYou don't have permission to use %1$s."),
